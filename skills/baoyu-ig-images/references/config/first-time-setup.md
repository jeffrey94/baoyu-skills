...
description: First-time setup flow for baoyu-ig-images preferences
---
...
options:
  ...
  - label: "clean-minimal"
    description: "White space, structured, professional"
  - label: "editorial"
    description: "Magazine-quality, mixed serif+sans"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.baoyu-skills/baoyu-ig-images/EXTEND.md` | Current project |
| User | `~/.baoyu-skills/baoyu-ig-images/EXTEND.md` | All projects |
