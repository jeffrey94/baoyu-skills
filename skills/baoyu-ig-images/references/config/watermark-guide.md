...
description: Watermark configuration guide for baoyu-ig-images
---
...
|--------|---------|-------|
| Handle | `@username` | Most common for Instagram |
| Text | `MyBrand` | Simple branding |
| URL | `myblog.com` | Cross-platform |

## Best Practices

1. **Consistency**: Use same watermark across all slides in series
...
| Inconsistent across slides | Use session ID for consistency |
